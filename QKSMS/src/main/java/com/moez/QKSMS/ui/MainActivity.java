...
public class MainActivity extends QKActivity {
    ...
    /*String AUTHORITY = "com.plamera.tmswiftlauncher.BlackListProvider";
    ...
    private void loadBlackList(){
        ...
        Log.d(TAG, "Get URI: "+String.valueOf(uri));
        if (c.moveToFirst()) {
            do{
                String blackListNum = c.getString(c.getColumnIndex(KEY_BLACK_LIST));
                Log.d(TAG,"GetContent: "+blackListNum);
            } while (c.moveToNext());
        }
    }*/
